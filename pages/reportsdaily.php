                ...
                <div class="card-body">  
                    <form action method="get" class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fdate"  tabindex="1" class="form-control" autocomplete="off"  value="<?php echo $fdate ?>"  
                            class="form-control datepicker date-format"   placeholder="dd-mm-yyyy"   onblur="ValidateDate(this, event.keyCode);" onkeydown="return DateFormat(this, event.keyCode)" maxlength="10" onfocus="this.select();">
                            </div>  
                    
                        <div class="form-group" style="margin-left:10px;">
                            <label>To Date : </label>
                            <input type="text" name="tdate"  tabindex="1" class="form-control" autocomplete="off"  value="<?php echo $tdate ?>"  
                            class="form-control datepicker date-format"   placeholder="dd-mm-yyyy"   onblur="ValidateDate(this, event.keyCode);" onkeydown="return DateFormat(this, event.keyCode)" maxlength="10" onfocus="this.select();">
