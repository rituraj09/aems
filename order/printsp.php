...
$qry = "SELECT head, office,depcode,dutycode, branch FROM `secpolling` group by depcode";
            ...
            <div class="row divfooter" style="font-size:11px !important;"> 
                ...
                <table  width="100%" >
                    <tr>
                      ...
                      <p>No.GLT/GEN.Elec/P.Cell/02/2021/10			<span style="float:right">Dated Golaghat the 2nd Mar.’2021</span></p>  
                        ...
                        <br>      
                         ...
                         <table style="width:100%;" border="1">
                                ...
                                Remarks
                                     ...
                                     <?php
                                    $oid=$r["depcode"];
                                    $qy = "SELECT * FROM `secpolling` where depcode = '$oid'";
