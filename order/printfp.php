...
$qry = "SELECT head, office,depcode, branch FROM `firstpolling` group by depcode";
            ...
            <div class="row divfooter" style="font-size:11px !important;"> 
                ...
                <table  width="100%" >
                    <tr>
                      ...
                      <p>No.GLT/GEN.Elec/P.Cell/02/2021/9			<span style="float:right">Dated Golaghat the 25th Feb.’2021</span></p>  
                        ...
                        <br>      
                            ...
                            <br><br>
                          <p> Sir/Madam, </p>  
                            <p style=" text-indent: 40px;  text-align: justify;" > With reference to the above, this is to inform you that the following employees under your establishment have been drafted for poll duty (First Polling Officer) for the forthcoming Assembly Election, 2021. You are directed to verify these details and revert back with updated list in both <b>hard and soft copy (Prescribed Excel format) on or before 27th Feb’2021 (in between 2:00pm to 5:00 pm) to the Personnel Cell (Shri Prayas Boruah, Cont: 9401911280), Assembly Election/2021, D.C’s Office, Golaghat (mail excel Sheet to golaghatelection@gmail.com)</b> without fail. </p>
                         <table style="width:100%;" border="1">
                                ...
                                Remarks
                                     ...
                                     <?php
                                    $oid=$r["depcode"];
                                    $qy = "SELECT * FROM `firstpolling` where depcode = '$oid'";
